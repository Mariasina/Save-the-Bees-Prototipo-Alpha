...
### Mecânicas do Player
- Sistema de movimentação básico (WASD)
- Pulo com transição para voo
- Sistema de tiro em terceira pessoa
- Sistema de vida e condição de morte

### Mecânicas dos Inimigos
- IA de perseguição
- Sistema de tiro direcionado ao jogador
- Sistema de vida e condição de morte

O foco atual do desenvolvimento está em:
- Refino da sistema de tiro
- Expansão do comportamento dos inimigos
- Implementação de sistema de spawn de hordas
- Implementação de buffs e debuffs
...
| Mover | `W` `A` `S` `D` |
| Pular | `Espaço` |
| Voar (pulo duplo) | `Espaço` duas vezes |
